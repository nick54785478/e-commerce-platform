...
public class UserBehavior {
     ...
     */
    private UserBehavior(TenantId tenantId, UserId userId, SessionId sessionId, ItemId itemId, 
     ...
     */
    public static UserBehavior log(TenantId tenantId, UserId userId, SessionId sessionId, ItemId itemId, 
                                   BehaviorType behaviorType, DeviceInfo deviceInfo, 
                                   String referrerUrl, BehaviorContext metadata, Instant timestamp) {
        return new UserBehavior(tenantId, userId, sessionId, itemId, behaviorType, deviceInfo, referrerUrl, metadata, timestamp);
    }
